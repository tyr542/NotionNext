...
export function GlobalContextProvider(props) {
  ...
  const contextValue = useMemo(() => ({
    ...
    categoryOptions,
    tagOptions
  }), [isLiteMode, isLoaded, isSignedIn, user, fullWidth, NOTION_CONFIG,
    THEME_CONFIG, toggleDarkMode, onLoading, lang, changeLang, locale,
    isDarkMode, theme, switchTheme, siteInfo, categoryOptions, tagOptions])
