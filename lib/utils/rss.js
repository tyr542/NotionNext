...
export async function generateRss(props) {
  if (rssGenerationPromise) {
    return rssGenerationPromise
  }

  rssGenerationPromise = generateRssInternal(props).finally(() => {
    rssGenerationPromise = null
  })

  return rssGenerationPromise
}

async function generateRssInternal(props) {
